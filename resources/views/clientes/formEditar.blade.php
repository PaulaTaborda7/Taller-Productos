	...
	<div class="container" id="formularioAgregar">
		...
		<form class="row g-4" action="{{ route('clientes.update', $cliente->id) }}" method="POST" enctype="multipart/form-data">
			...
			<div class="col-md-8">
				...
				<input type="text" class="form-control" id="validationCustom02" name="nombre" placeholder="Nombre" required value = "{{ $cliente->nombre }}">
			</div>

            <div class="col-md-8">
				<label for="validationCustom02" class="form-label">Correo</label>
				<input type="email" class="form-control" id="validationCustom02" name="correo" placeholder="Correo" required value = "{{ $cliente->correo }}">
			</div>
            ...
            <div class="col-md-8">
				...
				<input type="text" class="form-control" id="validationCustom02" name="direccion" placeholder="Dirección" required value = "{{ $cliente->direccion }}">
			</div>
